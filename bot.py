        ...
        for event in longpoll.listen():
            if event.type == VkBotEventType.MESSAGE_NEW:
                ...
                # ========== /BONUS (ежедневный бонус) ==========
                    ...
                    # Расчет бонуса: 100, 150, 200, 250, 300, 350, 500
                    if streak >= 6:
                        xp_reward = 500
                        new_streak = 0
                        message_part = f"🔥 Серия: {streak + 1} дней подряд!"
                    else:
                ...
                # ========== /DUEL (с пересчётом ставки) ==========
                    ...
                    win_amount = int(amount * 1.15)  # 115% от ставки при победе
                    lose_amount = int(amount * 0.85)  # 85% от ставки при поражении
                ...
                # ========== АДМИН КОМАНДЫ (mute, warn, kick, ban, setrank и т.д.) ==========
                # ... (оставляем из предыдущего кода)
